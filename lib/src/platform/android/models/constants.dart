...
//
// Used with [AdvertiseSetParameters.primaryPhy] and [AdvertiseSetParameters.secondaryPhy]
//
// Android API: BluetoothDevice.PHY_LE_*

/// Bluetooth LE 1M PHY
///
/// Standard 1 Mbit/s data rate, compatible with all BLE devices.
...
/// Bluetooth LE 2M PHY
///
/// 2 Mbit/s data rate, available on Bluetooth 5.0+ devices.
/// Higher throughput but shorter range than 1M.
///
