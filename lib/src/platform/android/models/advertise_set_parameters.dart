...
/// ```
///
/// Reference: https://developer.android.com/reference/android/bluetooth/le/AdvertisingSetParameters
///
...
class AdvertiseSetParameters {
  ...
  /// Default: false
  ///
  /// Android API: `AdvertisingSetParameters.Builder.setConnectable(connectable)`
  ...
  /// Default: false
  ///
  /// Android API: `AdvertisingSetParameters.Builder.setIncludeTxPower(transmissionPowerIncluded)`
  ...
  ///
  /// Scannable advertisements allow devices to request additional data
  /// via a scan response.
  ///
  ...
  ///
  /// The secondary channel is used for auxiliary advertising packets
  /// when using extended advertising (legacyMode = false).
  ///
  /// Valid values (from [constants.dart]):
  ...
  /// Default: null (uses system default)
  ///
  /// Android API: `AdvertisingSetParameters.Builder.setSecondaryPhy(secondaryPhy)`
  final int? secondaryPhy;

  /// TX (transmission) power level in dBm.
  ///
  /// Controls the transmission power level for advertising packets.
  /// Higher values = longer range but more battery consumption.
  ///
  /// Valid values (from [constants.dart]):
