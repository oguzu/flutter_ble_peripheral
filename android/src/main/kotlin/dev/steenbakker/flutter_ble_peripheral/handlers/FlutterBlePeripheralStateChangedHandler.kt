 ...
 * of the [FlutterBlePeripheralState] enum.
 *
 * Event channel name: `dev.steenbakker.flutter_ble_peripheral/ble_state_changed`
 */
class FlutterBlePeripheralStateChangedHandler(
    ...
    var state = FlutterBlePeripheralState.idle
     ...
     *
     * @param state The new [FlutterBlePeripheralState] to publish.
     */
    fun publish(state: FlutterBlePeripheralState) {
